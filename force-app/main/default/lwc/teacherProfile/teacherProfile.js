...
export default class TeacherProfile extends LightningElement {
    @api email;
    @track profile = {};
    @track form = {};
    ...
    async handleSave(event) {
        ...
        const { First_Name__c, Last_Name__c, Email__c, Department__c } = this.form;
        if (!First_Name__c || !Last_Name__c || !Email__c || !Department__c) {
